...
const nextConfig = {
  ...
  images: {
    ...
    minimumCacheTTL: 2592000, // 30 days CDN edge cache (prevents repeated active CPU re-encoding)
    remotePatterns: [
      {
        protocol: 'https',
  ...
  async headers() {
    const cspHeader = `
      ...
      img-src 'self' data: blob: https://images.unsplash.com https://*.amazonaws.com https://grainy-gradients.vercel.app https://*.clerk.com https://img.clerk.com https://www.googletagmanager.com https://*.google.com https://*.google.com.bd https://*.doubleclick.net https://*.trustpilot.com https://*.trustpilot.net https://*.partnero.com https://*.tawk.to https://tawk.link https://*.clarity.ms https://c.bing.com https://*.saashub.com https://cdn-b.saashub.com;
  ...
  async redirects() {
    return [
      ...
      { source: "/studio/maze", destination: "/maze", permanent: true },
    ];
  },
