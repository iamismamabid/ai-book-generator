...
const nextConfig = {
  ...
  async headers() {
    const cspHeader = `
      default-src 'self';
      script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.paddle.com https://public.profitwell.com https://*.clerk.accounts.dev https://clerk.kdpage.com https://*.clerk.com https://challenges.cloudflare.com https://us-assets.i.posthog.com https://us.i.posthog.com https://va.vercel-scripts.com https://*.arcade.software https://www.googletagmanager.com https://*.google-analytics.com https://*.googleadservices.com https://*.doubleclick.net https://invitejs.trustpilot.com https://*.partnero.com;
      style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.paddle.com;
      img-src 'self' data: blob: https://images.unsplash.com https://*.amazonaws.com https://grainy-gradients.vercel.app https://*.clerk.com https://img.clerk.com https://*.arcade.software https://www.googletagmanager.com https://*.google.com https://*.google.com.bd https://*.doubleclick.net https://*.partnero.com;
      font-src 'self' data: https://fonts.gstatic.com;
      connect-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://clerk.kdpage.com https://challenges.cloudflare.com https://us.i.posthog.com https://us-assets.i.posthog.com https://v2.paddle.com https://buy.paddle.com https://*.paddle.com https://*.amazonaws.com https://vitals.vercel-insights.com wss://*.clerk.accounts.dev https://*.arcade.software https://www.googletagmanager.com https://*.google-analytics.com https://*.google.com https://*.doubleclick.net https://*.partnero.com;
      frame-src 'self' https://buy.paddle.com https://*.paddle.com https://*.clerk.accounts.dev https://*.clerk.com https://challenges.cloudflare.com https://app.arcade.software https://*.arcade.software https://www.googletagmanager.com;
