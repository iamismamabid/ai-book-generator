...
const faqs = [
  ...
  },
  {
    ...
    answer: "KDPage offers flexible Monthly, Annual, and Lifetime Deal plans (Starter Creator, Pro Studio, and Publisher Agency) with a 7-day trial for $1. You can upgrade, downgrade, or cancel your subscription at any time directly from your account dashboard's Manage Billing link."
  }
];
