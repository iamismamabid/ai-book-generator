...
const faqs = [
  ...
  },
  {
    ...
    answer: "By purchasing this AppSumo deal, you get lifetime access to Ismam Studio's puzzle creator tools and cover editors. You pay once now and avoid recurring monthly subscription costs, while receiving all future updates to our core generators."
  }
];
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => {
              ...
              return (
                <div
                  key={index}
                  className="border border-slate-800/80 bg-slate-900/30 rounded-2xl overflow-hidden transition-all duration-300"
                >
                  <button
                  ...
                  {isOpen && (
                    <div className="px-6 pb-6 text-slate-300 text-sm font-medium leading-relaxed border-t border-slate-800/50 pt-4">
                      {faq.answer}
                    </div>
                  )}
                </div>
