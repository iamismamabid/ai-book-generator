  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "KDPage offers flexible Monthly and Annual subscription plans (Starter Creator, Pro Studio, and Publisher Agency) with a 7-day free trial. You can upgrade, downgrade, or cancel your subscription at any time directly from your account dashboard's Manage Billing link."
        }
      }
    ]
  };
