...
export default function GeneratePage() {
  ...
  return (
    <main className="min-h-screen bg-[#0b0f19] text-slate-100 py-12 px-6 relative overflow-hidden">
      ...
      {isAuthModalOpen && (
        <div
          className="fixed inset-0 z-[99999] bg-slate-950/65 backdrop-blur-sm flex items-center justify-center p-4 pt-28"
          onClick={() => setIsAuthModalOpen(false)}
        >
          <div
            className="bg-slate-900 border border-slate-800 p-8 rounded-3xl max-w-md w-full shadow-2xl text-center space-y-6 animate-in zoom-in-95 duration-200"
