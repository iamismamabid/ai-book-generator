      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mb-8 flex items-center justify-between print:hidden">
          ...
          <button
            ...
            className="px-4 py-2 bg-slate-900 border border-slate-800 hover:bg-slate-800 text-slate-350 hover:text-white rounded-xl text-xs font-black flex items-center gap-2 transition"
          >
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-[2.5rem] p-8 md:p-12 shadow-2xl space-y-8 print:border-0 print:shadow-none print:p-0 print:bg-transparent">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-450 text-xs font-semibold uppercase tracking-wider mt-1 print:text-slate-650">Ismam Studio Publishing Guide</p>
            </div>
          </div>
          ...
          <div className="space-y-8 text-slate-300 text-sm font-medium leading-relaxed print:text-black">
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-2 text-base font-bold text-white print:text-black border-b border-slate-850 pb-2 print:border-slate-300">
                <Key className="w-5 h-5 text-indigo-400 print:text-black shrink-0" />
                <h3>Phase 1: Niche Validation & Keywords</h3>
              </div>
              <ul className="space-y-3 pl-6 list-disc text-slate-400 print:text-slate-850">
          ...
          <div className="pt-6 border-t border-slate-850 text-center print:hidden">
            <Link
              href="/studio"
