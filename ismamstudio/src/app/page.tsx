      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-6 py-24 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            { title: "AI Coloring Artbook Studio", desc: "Turn text ideas or photos into printable vector coloring pages, mandalas, and complete KDP artbooks.", href: "/studio/artbook", icon: Paintbrush, badge: "AI Generator" },
