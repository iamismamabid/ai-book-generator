      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-6 py-24 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            { title: "Picross Studio", desc: "Japanese picture-logic puzzles, 5x5 to 15x15, with 50+ pixel art presets, custom drawing, and 300 DPI book export.", href: "/studio/nonogram", icon: Palette, badge: "Picture Logic" },
