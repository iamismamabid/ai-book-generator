...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f19] text-slate-100 overflow-hidden relative">
      ...
      {/* 🏷️ ISBN Barcode Generator Section */}
      <section className="relative z-10 max-w-5xl mx-auto px-6 pb-12">
        <div className="bg-gradient-to-r from-indigo-950/40 via-purple-950/20 to-slate-900/40 backdrop-blur-md rounded-[3rem] border border-indigo-900/35 p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-2xl">
          {/* Decorative glows */}
          <div className="absolute -right-20 -top-20 w-60 h-60 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="space-y-4 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 text-xs font-bold text-slate-400 justify-center md:justify-start">
              <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-indigo-400" /> 300 DPI print-ready</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-indigo-400" /> ISBN-13 check digit validation</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-indigo-400" /> EAN-5 price supplement codes</span>
            </div>
          </div>

          <div className="shrink-0 bg-indigo-500/10 border border-indigo-500/20 px-6 py-8 rounded-3xl text-center max-w-[200px] w-full mx-auto md:mx-0">
            <span className="text-[10px] font-black uppercase tracking-wider text-indigo-400 block mb-2">Barcode Utility</span>
            <span className="text-xs text-slate-300 font-semibold block mb-4">No registration or account required</span>
            <Link
              href="/tools/isbn-generator"
              className="inline-block w-full px-4 py-2.5 bg-indigo-655 hover:bg-indigo-600 text-white font-black text-xs rounded-xl shadow-md transition"
            >
              Use Free Barcode Tool
            </Link>
          </div>
        </div>
      </section>
