          ...
          <div className="space-y-8 text-slate-300 text-sm font-medium leading-relaxed">
            <section className="space-y-3">
              ...
              <ul className="list-disc list-inside pl-4 space-y-2 text-slate-400">
                ...
                <li>Marketplace redemption data (license/activation code and purchase verification status) if you activate your account through a licensed marketplace partner such as Dealify, DealFuel, AppSumo, or Gumroad.</li>
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc list-inside pl-4 space-y-2 text-slate-400">
                ...
                <li><strong>Marketplace Partners (Dealify, DealFuel, AppSumo, Gumroad):</strong> If you purchase a license through an authorized marketplace partner, we receive your redemption code and purchase verification status to activate the corresponding plan on your account. Your purchase and payment details remain governed by the respective marketplace's own privacy policy.</li>
              </ul>
            </section>
