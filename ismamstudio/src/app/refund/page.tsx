...
export const metadata: Metadata = {
  ...
  description: "Read the comprehensive Refund Policy of KDPage. Learn about our 3-day money-back guarantee, fair usage terms, Lifetime Deal marketplace policy, and Paddle Merchant of Record terms.",
};
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-[2.5rem] p-8 md:p-12 shadow-2xl">
          ...
          <div className="space-y-8 text-slate-300 text-sm font-semibold leading-relaxed">
            <section className="space-y-3">
              <h2 className="text-xl font-black text-white">1. Overview & 3-Day Money-Back Guarantee</h2>
              <p>
                We stand behind the quality of KDPage and want you to feel confident in your purchase. We offer a **3-day conditional money-back guarantee** for all direct SaaS subscription plans purchased via our platform. If you're not delighted, get an instant full refund within 3 days.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                Refunds under the 3-day guarantee apply to **first-time purchases only**. Subscription renewals, repeat purchases of a previously refunded plan, and plan upgrades from an existing paid plan are non-refundable.
              </p>
            ...
            <section className="space-y-3">
              ...
              <p>
                Annual plans are covered by the same **3-day money-back guarantee** from the date of purchase. After 3 days, annual plans are non-refundable, but you may cancel auto-renewal at any time to prevent future billing cycles.
              </p>
            </section>
