...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    return [
        ...
        {
            url: `${baseUrl}/studio/nonogram`,
            lastModified: new Date(),
            changeFrequency: 'weekly',
            priority: 0.85,
        },
        {
            url: `${baseUrl}/studio/calcudoku`,
            lastModified: new Date(),
            changeFrequency: 'weekly',
            priority: 0.85,
        },
        ...
        {
            url: `${baseUrl}/studio/slitherlink`,
            lastModified: new Date(),
            changeFrequency: 'weekly',
            priority: 0.85,
        },
        {
            url: `${baseUrl}/studio/nurikabe`,
            lastModified: new Date(),
            changeFrequency: 'weekly',
            priority: 0.85,
        },
        ...
        {
            url: `${baseUrl}/tools/kdp-book-description-generator`,
            lastModified: new Date(),
            changeFrequency: 'weekly',
            priority: 0.95,
        },
        ...
        {
            url: `${baseUrl}/compare/publisher-rocket`,
            lastModified: new Date(),
            changeFrequency: 'weekly',
            priority: 0.85,
        },
        {
            url: `${baseUrl}/compare/creative-fabrica`,
            lastModified: new Date(),
            changeFrequency: 'weekly',
            priority: 0.85,
        },
