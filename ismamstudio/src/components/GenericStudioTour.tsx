    ...
    steps: [
      {
        ...
        content: "Create 300 DPI vector coloring pages and complete KDP interior books in seconds. Let's take a quick 30-second tour!",
      },
      {
        target: '[data-tour="select-template"]',
        title: "1. Pick a Template or Upload Photo",
        content: "Select from 67+ vector templates (mandalas, floral, stained glass, flags) or upload your own PNG/JPG photo to convert to line art!",
      },
      {
        target: '[data-tour="customization-controls"]',
        title: "2. Customization Controls",
        content: "Adjust line thickness, pattern complexity density, border frames, color-by-number overlays, and KDP trim sizes.",
      },
      {
        target: '[data-tour="interactive-coloring"]',
        title: "3. Interactive Coloring Canvas",
        content: "Try coloring your page directly in-browser using brush, flood fill, eyedropper, text tool, zoom, and 30 pro colors!",
      },
      {
        target: '[data-tour="export-actions"]',
        title: "4. Export 300 DPI PNG & KDP PDF Interior",
        content: "Download a single 300 DPI high-res page or generate a complete 30-100 page print-ready KDP interior PDF book!",
      },
    ],
  },
  wordSearch: {
