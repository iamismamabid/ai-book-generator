      ...
      <div className="w-80 bg-slate-900 text-slate-100 flex flex-col border-r border-slate-800 z-10">
        <div className="p-4 border-b border-slate-800 flex flex-col gap-2.5">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="inline-flex items-center gap-1.5 text-amber-500 font-black text-[10px] uppercase bg-amber-500/10 px-2.5 py-1 rounded-full border border-amber-500/20 whitespace-nowrap shrink-0">
              <Sliders className="w-3 h-3"/> Scramble
            </div>
          </div>
          <GenericStudioTour tourKey="wordScramble" className="w-full inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-full bg-gradient-to-r from-amber-400 via-amber-500 to-yellow-500 hover:from-amber-500 hover:to-yellow-600 text-slate-950 font-black text-[11px] uppercase tracking-wider shadow-md shadow-amber-500/20 hover:shadow-lg hover:shadow-amber-500/30 hover:scale-[1.01] active:scale-95 transition-all cursor-pointer border border-amber-300/60 shrink-0 whitespace-nowrap" />
        </div>
          ...
          {puzzles.length > 0 && puzzles[activePreviewIndex] ? (
            ...
            >
              ...
              <div className="flex flex-col h-full justify-between">
                ...
                {/* Word Bank Area */}
                {difficulty !== "hard" && (
                  <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-3 text-center mt-3">
